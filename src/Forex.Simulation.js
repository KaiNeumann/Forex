...
Forex.Simulation = K.Base.subclass({
    ...
    , run: function(){
        ...
        var i,j,k,l;
        var   tickSpeed = Number.MAX_VALUE    //min der timeframes aller timelines
            , startDate = 0                    //max der startIndices aller Timeframes
            , stopDate = Number.MAX_VALUE    //min der letzten Dates aller Timeframes
            , timeline
            , date
    ...
    , plot: function(){
        ...
        var tradeTimeline = Forex.Timeline.create({
            ...
            , indicators: [ tradeIndicators.chi2 ]
        });
        $.plot(simplot3, [ 
