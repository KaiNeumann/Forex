...
K.require("Forex.Simulation.js",function(){
...
Forex.Simulation.Statistic = K.Base.subclass({
    ...
    , getSummary:function(){
        ...
        return $KDE("table"
            , $KDE("tr",$KDE("td","Result"),$KDE("td",this.balance.toFixed(4)) )
            , $KDE("tr",$KDE("td","Trades"),$KDE("td",this.alltrades.number) )
            , $KDE("tr",$KDE("td","T-Test"),$KDE("td",this.t_test.toFixed(4)) )
            , $KDE("tr",$KDE("td","Success ratio"),$KDE("td",this.successratio.toPercent(4)) )
            , $KDE("tr",$KDE("td","Positive Unrealized"),$KDE("td",this.unrealized_positive.toPercent(4)) )
            , $KDE("tr",$KDE("td","R2"),$KDE("td",this.r2.toFixed(4)) )
            , $KDE("tr",$KDE("td","Max Drawdown"),$KDE("td",this.max_rel_drawdown.toPercent(4)) )
            , $KDE("tr",$KDE("td","Rating"),$KDE("td",this.rating.toFixed(4)) )
        );
