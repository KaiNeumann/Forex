...
Forex.Strategy = K.Base.subclass({
    ...
    , runonce:function(parameterSet){
        ...
        this.UI.insertSimulationResult( result.simulation.plot() ); //output logs, graphs, statistics, ...
    }
    , iterate:function(n){
        var parameterSet={};
        var r = {}, best={};
...
K.require("Forex.Strategy.Parameter.js","Forex.Strategy.UI.js","Forex.Strategy.Statistic.js");